...
#    pass
#sapi.filter(track=['aftershock','airplane accident','annihilated','annihilation','apocalypse','armageddon','arson','arsonist','avalanche','battle','bioterror','bioterrorism','blizzard','bomb','bombed','bombing','bridge collapse','burn', 'casualties','casualty','catastrophe','catastrophic','chemical emergency','cyclone','dead','death','deaths','derail','derailed','derailment','desolate','desolation','destroy','destroyed','destruction','detonate','detonation','devastated','devastation','disaster','displaced','drought','drown','drowned','drowning','dust storm','earthquake','explode','exploded','explosion','eyewitness','famine','fatal','fatalities','fatality','fear','fire','flood','flooding','floods','forest fire','hailstorm','harm','hazard','hazardous','heat wave','hellfire','hijack','hijacker','hijacking','hostage','hostages','hurricane','injured','injuries','injury','landslide','lava','lightning','loud bang','mass murder','mass murderer','massacre','mayhem','meltdown','mudslide','natural disaster','nuclear disaster','nuclear reactor','oil spill','outbreak','pandemonium','panic','panicking','quarantine','quarantined','radiation emergency','rainstorm','razed','refugees','rescue','rescued','rescuers','riot','rioting','rubble','ruin','sandstorm','screamed','screaming','screams','seismic','sinkhole','sinking','siren','sirens','smoke','snowstorm','storm','stretcher','structural failure','suicide bomb','suicide bomber','suicide bombing','sunk','terrorism','terrorist','threat','thunder','thunderstorm','tornado','tragedy','trapped','tsunami','twister','typhoon','upheaval','violent storm','volcano','war zone','weapon','weapons','whirlwind','wild fires','wildfire','windstorm','wreck','wreckage','wrecked'])
