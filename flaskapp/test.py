...
#nameCount = 0 
#for j in listCreation:
     #newList =countContent.keys()[nameCount]
     #print newList
     #listCreations = newList + j
     #print listCreations
     #nameCount += 1
        #print j
    #listCreation[i['count']]
    #date.append(i['date'])
    #accident.append(i['count']['accident'])
    #print i
#print date , accident
#listCreation['bomb']
print listCreation
