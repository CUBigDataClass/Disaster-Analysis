...
#print dateFromMarch
#print dateFromMarch + differenceOf24Hours
...
#dateFromMarch24HoursExtra = dateFromMarch + differenceOf24Hours;
#    print dateFromMarch
#    print dateFromMarch24HoursExtra
analysisData=db['oneMonth']
TweetsGatheredPerDay = Tweets.find({"created_at" : { '$gt' : dateFromMarch , '$lt': currentDate }})
    #print len(TweetsGatheredPerDay)
for content in TweetsGatheredPerDay:
